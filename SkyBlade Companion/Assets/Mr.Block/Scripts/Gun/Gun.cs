...
public class Gun : MonoBehaviour
{
    ...
    [SerializeField] private Transform _bulletShellSpawnPoint;
    [SerializeField] private Bullet _bulletPrefab;
    [SerializeField] private GameObject _bulletShellPrefab;
    [SerializeField] private GameObject _gunFlamePrefab;
    ...
    private void OnEnable()
    {
        ...
        OnShoot += BulletFlames;
        OnShoot += BulletShells;
        OnShoot += MuzzleFlash;
    ...
    private void BulletShells()
    {
        Instantiate(_bulletShellPrefab, _bulletShellSpawnPoint.position, transform.rotation);
    }

    private void BulletFlames()
    {
        Instantiate(_gunFlamePrefab, _bulletSpawnPoint.position, transform.rotation);
    }
