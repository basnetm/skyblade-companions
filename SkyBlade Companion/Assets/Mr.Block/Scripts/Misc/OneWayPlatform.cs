...
public class OneWayPlatform : MonoBehaviour
{
    ...
    {
        if (other.gameObject.GetComponent<BPlayerController>())
        {
    ...
    private void DetectPlayerInput()
    {
        ...
        if(BPlayerController.Instance.MoveInput.y < 0f)
        {
    ...
    {
        Collider2D[] playerColliders = BPlayerController.Instance.GetComponents<Collider2D>();
